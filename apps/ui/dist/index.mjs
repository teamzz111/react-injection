...
var Badge = ({
  ...
  return /* @__PURE__ */ jsx3("div", { className: badgeClasses, ...props, children });
};
...
var Modal = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx4("div", { className: "fixed inset-0 flex items-center opacity-50 justify-center z-50 p-4", children: /* @__PURE__ */ jsxs(
      "div",
      {
        className: `bg-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-auto ${className}`,
        onClick: (e) => e.stopPropagation(),
        children: [
          (title || showCloseButton) && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b", children: [
            title && /* @__PURE__ */ jsx4("h2", { className: "text-lg font-semibold", children: title }),
          ...
          /* @__PURE__ */ jsx4("div", { className: "p-4", children })
        ]
      }
    ) })
  ] });
